...
@ActiveProfiles("testcontainers") // it uses MySQL DB config for MySQL integration testing support
class EmployeeRepositoryIntegrationTestsTC extends AbstractContainerBaseTest {
